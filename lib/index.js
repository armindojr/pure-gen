...
function Pure (opts) {
  ...
  var _definitions = {
    ...
    "address": ["city_prefix", "city_suffix", "street_suffix", "city_name", "county", "country", "default_country", "country_code", "country_code_alpha_3", "state", "state_abbr", "street_prefix", "postcode", "postcode_by_state", "direction", "direction_abbr"],
...
Pure.prototype.setLocale = function (locale) {
  this.locale = locale;
}

Pure.prototype.seed = function(value) {
  var Random = require('./random');
