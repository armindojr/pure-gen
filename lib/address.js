...
function Address (pure) {
  ...
  this.zipCode = function(format) {
    ...
    if (typeof format === 'undefined') {
      var localeFormat = pure.definitions.address.postcode;
      if (typeof localeFormat === 'string') {
        format = localeFormat;
      } else {
        format = pure.random.arrayElement(localeFormat);
      }
    }
  ...
  this.zipCodeByState = function (state) {
    var zipRange = pure.definitions.address.postcode_by_state[state];
    if (zipRange) {
  ...
  this.cityPrefix = function () {
    return pure.random.arrayElement(pure.definitions.address.city_prefix);
  }
  ...
  this.citySuffix = function () {
    return pure.random.arrayElement(pure.definitions.address.city_suffix);
  }
  ...
  this.cityName = function () {
    return pure.random.arrayElement(pure.definitions.address.city_name);
  }
  ...
  this.streetName = function () {
      var result;
      var suffix = pure.address.streetSuffix();
      if (suffix !== "") {
          suffix = " " + suffix
      }
  ...
  this.streetAddress = function (useFullAddress) {
      ...
      return useFullAddress ? (address + " " + pure.address.secondaryAddress()) : address;
  }
  ...
  this.streetSuffix = function () {
      return pure.random.arrayElement(pure.definitions.address.street_suffix);
  }
  ...
  this.streetPrefix = function () {
      return pure.random.arrayElement(pure.definitions.address.street_prefix);
  }
  ...
  this.secondaryAddress = function () {
      return Helpers.replaceSymbolWithNumber(pure.random.arrayElement(
          [
              'Apt. ###',
              'Suite ###'
          ]
  ...
  this.county = function () {
    return pure.random.arrayElement(pure.definitions.address.county);
  }
  ...
  this.country = function () {
    return pure.random.arrayElement(pure.definitions.address.country);
  }
  ...
  this.defaultCountry = function () {
    return pure.random.arrayElement(pure.definitions.address.default_country);
  }
  ...
  this.stateAbbr = function () {
      return pure.random.arrayElement(pure.definitions.address.state_abbr);
  }
