...
function Database(pure) {
     ...
     * //outputs: "createdAt"
     */
    this.column = () => pure.random.arrayElement(pure.definitions.database.column);
     ...
     * //outputs: "blob"
     */
    this.type = () => pure.random.arrayElement(pure.definitions.database.type);
     ...
     */
    this.collation = () => pure.random.arrayElement(pure.definitions.database.collation);
     ...
     * //outputs: "MEMORY"
     */
    this.engine = () => pure.random.arrayElement(pure.definitions.database.engine);
}
