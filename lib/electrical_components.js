...
function ElectricalComponents(pure) {
     ...
     * //outputs: "Diode"
     */
    self.active = () => pure.random.arrayElement(pure.definitions.electricalComponents.active);
     ...
     * //outputs: "Varistor"
     */
    self.passive = () => pure.random.arrayElement(pure.definitions.electricalComponents.passive);
     ...
     * //outputs: "crystal"
     */
    self.electromechanical = () => pure.random.arrayElement(pure.definitions.electricalComponents.electromechanical);
}
