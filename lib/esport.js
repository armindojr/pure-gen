...
function Esport(pure) {
     ...
     * //outputs: "shroud"
     */
    self.players = () => pure.random.arrayElement(pure.definitions.esport.players);
     ...
     * //outputs: "FaZe"
     */
    self.teams = () => pure.random.arrayElement(pure.definitions.esport.teams);
     ...
     * //outputs: "ESL Cologne"
     */
    self.events = () => pure.random.arrayElement(pure.definitions.esport.events);
     ...
     * //outputs: "IEM"
     */
    self.leagues = () => pure.random.arrayElement(pure.definitions.esport.leagues);
     ...
     * //outputs: "CS:GO"
     */
    self.games = () => pure.random.arrayElement(pure.definitions.esport.games);
}
