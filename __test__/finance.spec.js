...
describe('finance.js', () => {
    ...
    describe('bitcoinAddress()', () => {
        it('returns a random bitcoin address', () => {
            ...
            expect(/^[13][a-km-zA-HJ-NP-Z1-9]{24,33}$/.test(bitcoinAddress));
        });
    });
    ...
    describe('ethereumAddress()', () => {
        it('returns a random ethereum address', () => {
            ...
            expect(/^(0x)[0-9a-f]{40}$/.test(ethereumAddress));
        });
    });
    ...
    describe('litecoinAddress()', () => {
        it('returns a random litecoin address', () => {
            ...
            expect(/^[LM3][a-km-zA-HJ-NP-Z1-9]{26,33}$/.test(litecoinAddress));
        });
    });
