export default class Address {
    ...
    city(state) {
        ...
        if (typeof def !== 'string') {
            if (this.pure.registeredModules.address.city[def] === undefined) {
                def = this.pure.random.objectElement(
                    this.pure.registeredModules.address.city,
                    'key',
                );
            } else {
        ...
        let result = this.pure.random.arrayElement(
            this.pure.registeredModules.address.city[def],
        );
    ...
    countryCode(alphaCode) {
        ...
        if (alphaCode === 'alpha-3') {
            code = this.pure.random.arrayElement(
                this.pure.registeredModules.address.countryCodeAlpha3,
            );
        } else {
            code = this.pure.random.arrayElement(
                this.pure.registeredModules.address.countryCode,
            );
        }
    ...
    direction(useAbbr) {
        ...
        if (useAbbr) {
            direction = this.pure.random.objectElement(
                this.pure.registeredModules.address.directionAbbr,
            );
        } else {
            direction = this.pure.random.objectElement(
                this.pure.registeredModules.address.direction,
            );
        }
    ...
    ordinalDirection(useAbbr) {
        ...
        if (useAbbr) {
            ...
            result = this.pure.random.arrayElement(
                this.pure.registeredModules.address.direction.ordinal,
            );
        }
