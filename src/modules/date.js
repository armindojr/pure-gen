...
class pureDate {
    constructor(pure) {
        ...
        this.month = (options) => {
            ...
            if (opt.context && typeof pure.registeredModules.date.month[`${type}_context`] !== 'undefined') {
                type += '_context';
            }
        ...
        this.weekday = (options) => {
            ...
            if (opt.context && typeof pure.registeredModules.date.weekday[`${type}_context`] !== 'undefined') {
                type += '_context';
            }
