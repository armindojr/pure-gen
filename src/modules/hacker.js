...
function Hacker(pure) {
     ...
     * //outputs: "SSL"
     */
    this.abbreviation = () => pure.random.arrayElement(pure.definitions.hacker.abbreviation);
     ...
     * //outputs: "1080p"
     */
    this.adjective = () => pure.random.arrayElement(pure.definitions.hacker.adjective);
     ...
     * //outputs: "alarm"
     */
    this.noun = () => pure.random.arrayElement(pure.definitions.hacker.noun);
     ...
     * //outputs: "override"
     */
    this.verb = () => pure.random.arrayElement(pure.definitions.hacker.verb);
     ...
     */
    this.ingverb = () => pure.random.arrayElement(pure.definitions.hacker.ingverb);
